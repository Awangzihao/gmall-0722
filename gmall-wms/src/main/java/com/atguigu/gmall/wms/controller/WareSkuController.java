...
public class WareSkuController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> queryWareSkuBySkuId(@PathVariable("skuId") Long lon){
        List wareSkuEntities=wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id",lon));
