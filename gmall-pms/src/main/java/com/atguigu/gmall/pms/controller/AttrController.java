...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrsByCid(@RequestParam("cid")Long cid,@RequestParam(value = "type",defaultValue = "0")Integer type,QueryCondition queryCondition){
        PageVo page = attrService.queryAttrsByCid(cid,type,queryCondition);
        return Resp.ok(page);
    }
